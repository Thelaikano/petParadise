...
export default function Nav() {
  const handleConocenos = () => window("#conocenos");
  return (
    <nav className="nav-barra">
      <a className="nav-inicio" href="#app">
        <img src="logo.png" alt="" />
        <span>Inicio</span>
      </a>

      <a className="nav-conocenos" href="#conocenos">
        <svg
      ...
      <a className="nav-servicios" href="#servicios">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
      ...
      <a className="nav-instalaciones" href="#instalaciones">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
      ...
      <a className="nav-contacto" href="#contacto">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
